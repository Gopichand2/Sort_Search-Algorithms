...
public class Search_Sort extends JFrame implements ActionListener {
	...
	Search_Sort(){
        ...
        combo1.setFont(new Font("Arial", Font.BOLD, 25));
	...
	setVisible(true);
		...
		if(index==0)
		{
			...
			if(pos1==-1)
				...
				res1+=String.valueOf(key)+" found at "+(String.valueOf(pos1))+" !";
			l3.setText(res1);
			}
		...
		else if(index==1)
		{
		    ...
		    if(pos2>0)
				res2+=String.valueOf(key)+" found at "+(String.valueOf(pos2))+" !";
			else
